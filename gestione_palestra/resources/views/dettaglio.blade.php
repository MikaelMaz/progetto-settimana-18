                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg text-center">
                            <div class="p-6 text-gray-900">
                                ...
                                <ul class="list-disc list-inside mb-4">
                                    ...
                                    <li><strong>Orario inizio:</strong> {{ \Carbon\Carbon::parse($corsi->inizio)->format('H') }}:00</li>
                                    <li><strong>Orario fine:</strong> {{ \Carbon\Carbon::parse($corsi->fine)->format('H') }}:00</li>
                                </ul>
                            </div>
                        </div>
                        <a type="button" class="btn btn-outline-dark mt-4 w-100" href="/corsi">Torna ai corsi</a>
